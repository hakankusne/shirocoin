...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "shirocoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"shirocoin.org", "seed.shirocoin.org"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"shirocoin.org", "seed.testnet.shirocoin.org"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. shirocoin is probably already running."), addrBind.ToString().c_str());
        else
