...
uint256 hashGenesisBlock("0x869a8f53469172bef39f0dde7b1cd2bcbcda8eb7f3eb0d7d31cbc05e3ee5b8f8");
static CBigNum bnProofOfWorkLimit = CBigNum().SetCompact(504365644); // shirocoin: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "shirocoin Signed Message:\n";
...
{
    // shirocoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 840000); // shirocoin: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 302400; // shirocoin: 3.5 days
static const int64 nTargetSpacing = 120; // shirocoin: 2.5 minutes
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // shirocoin: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // shirocoin: Special short-term limits to avoid 10,000 BDB lock limit:
...
{
    // shirocoin: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x9c37d119d70b593feb7d5290d68f287ee76cb49bcc45d4025ee69aecdaa7355d");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "The coin to change the game.";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 5000000000;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("09619f5cec0df5ba18c654500ef083da40520fa993eabd52ea65053176ab397d0633e9e1ddad6932a5b58d4041d5873259c38e38faea6e2c3929156baf094a9606") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1520682602;
        block.nBits    = 504365644;
        block.nNonce   = 3319192106;

        if (fTestNet)
        {
            block.nTime    = 1520682602;
            block.nNonce   = 1038652436;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x8b6ac2c049a4b17eac0f39d76192de0ce5557deb64a56807d58d4fa4d92d5f1e"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // shirocoin: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("shirocoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("shirocoinMiner : ProcessBlock, block not accepted");
    }
